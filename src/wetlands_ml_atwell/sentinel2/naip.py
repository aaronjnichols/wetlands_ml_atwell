...
def prepare_naip_reference(
    ...
    Optionally resamples to a target resolution.
    
    Args:
        sources: Sequence of paths to NAIP GeoTIFF files.
        working_dir: Directory for output files (mosaic, resampled).
    ...
    # Validate consistency across tiles
    crs = None
    resolution = None
    band_count = None
    ...
    # Single tile: optionally resample, return directly
    if len(sources) == 1:
